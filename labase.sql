...
--
-- Servidor: localhost
-- Tiempo de generación: 10-01-2012 a las 16:11:56
...
INSERT INTO `Tareas` (`id`, `Nombre`, `Fecha`, `Socio`, `Notas`, `Terminada`) VALUES
(1, 'hacer inners', '2012-12-27 00:00:00', 2, 'eso, hacer inner en controller con dos bases', 0),
(2, 'prueba', '2006-01-01 00:00:00', 3, '33333', 0);
--
...
(NULL, 'Socios', 'Asociados', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Asociados', 'socios', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Asociados', 'nome', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Mano', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Mano', 'Nombre', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Mano', 'Especialidad', 3, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Mano', 'Fecha_De_Nacimiento', 4, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Tareas', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Tareas', 'Nombre', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Tareas', 'Fecha', 3, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Tareas', 'Socio', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Tareas', 'Notas', 5, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'Socios', 'Tareas', 'Terminada', 6, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
...
('QCACHE_FREE_MEMORY', '16734960'),
('QCACHE_HITS', '36'),
('QCACHE_INSERTS', '37'),
('QCACHE_LOWMEM_PRUNES', '0'),
('QCACHE_NOT_CACHED', '123'),
('QCACHE_QUERIES_IN_CACHE', '28'),
('QCACHE_TOTAL_BLOCKS', '66'),
('QUERIES', '668'),
('QUESTIONS', '668'),
('RPL_STATUS', 'NULL'),
('SELECT_FULL_JOIN', '6'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '1982'),
('UPTIME_SINCE_FLUSH_STATUS', '1982');
...
('BASEDIR', '/usr/'),
('PID_FILE', '/var/lib/mysql/javier-VirtualBox.pid'),
...
('LOG_BIN', 'OFF'),
('GENERAL_LOG_FILE', '/var/lib/mysql/javier-VirtualBox.log'),
...
('MAX_TMP_TABLES', '32'),
('TIMESTAMP', '1326208318'),
('SQL_LOG_OFF', 'OFF'),
('MAX_DELAYED_THREADS', '20'),
('SLOW_QUERY_LOG_FILE', '/var/lib/mysql/javier-VirtualBox-slow.log'),
...
(NULL, 'Socios', 'PRIMARY', NULL, 'Socios', 'Asociados', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'Socios', 'PRIMARY', NULL, 'Socios', 'Mano', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'Socios', 'PRIMARY', NULL, 'Socios', 'Tareas', 'id', 1, NULL, NULL, NULL, NULL),
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, NULL, '', '', NULL),
(NULL, 'Socios', 'Asociados', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 4194304, '2012-01-10 15:04:49', NULL, NULL, NULL, '', '', NULL),
(NULL, 'Socios', 'Mano', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 4194304, '2011-12-22 15:50:18', NULL, NULL, NULL, '', '', NULL),
(NULL, 'Socios', 'Tareas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 4194304, '2012-01-10 15:04:49', NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2011-12-22 15:00:18', '2011-12-22 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 440, 440, 123848989752688639, 5120, 0, '2011-12-22 15:00:19', '2011-12-22 15:03:49', '2011-12-22 15:00:19', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-22 15:00:19', '2011-12-22 15:00:19', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2011-12-22 15:00:18', '2011-12-22 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 452, 197, 89044, 55450570411999231, 16384, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 993, 9, 8937, 2533274790395903, 17408, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 857, 435464, 281474976710655, 20480, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2011-12-22 15:00:19', '2011-12-22 15:00:19', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-22 15:00:19', '2011-12-22 15:00:19', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2011-12-22 15:00:19', '2011-12-22 15:00:19', '2011-12-22 15:00:19', NULL, '', '', NULL),
(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2011-12-22 15:00:18', '2011-12-22 15:00:18', '2011-12-22 15:00:18', NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 96, 484, 281474976710655, 2048, 0, '2011-12-22 15:00:19', '2011-12-22 15:03:49', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_bookmark', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_column_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_designer_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_history', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_pdf_pages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_table_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_table_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_tracking', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 2048, 0, '2011-12-22 15:03:50', '2011-12-22 15:49:40', NULL, NULL, '', '', NULL);
...
('binlog', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'MySQL AB', 'This is a pseudo storage engine to represent the binlog in a transaction', 'GPL'),
('partition', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'Mikael Ronstrom, MySQL AB', 'Partition Storage Engine Helper', 'GPL'),
('ARCHIVE', '3.0', 'ACTIVE', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'Brian Aker, MySQL AB', 'Archive storage engine', 'GPL'),
('BLACKHOLE', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'MySQL AB', '/dev/null storage engine (anything you write to it disappears)', 'GPL'),
('CSV', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'Brian Aker, MySQL AB', 'CSV storage engine', 'GPL'),
('FEDERATED', '1.0', 'DISABLED', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'Patrick Galbraith and Brian Aker, MySQL AB', 'Federated MySQL storage engine', 'GPL'),
('MEMORY', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'MySQL AB', 'Hash based, stored in memory, useful for temporary tables', 'GPL'),
('InnoDB', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'Innobase OY', 'Supports transactions, row-level locking, and foreign keys', 'GPL'),
('MyISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'MySQL AB', 'Default engine as of MySQL 3.23 with great performance', 'GPL'),
('MRG_MYISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50158.0', NULL, NULL, 'MySQL AB', 'Collection of identical MyISAM tables', 'GPL');
...
(120, 'root', 'localhost', 'Socios', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(119, 'phpmyadmin', 'localhost', NULL, 'Sleep', 2, '', NULL);
...
(NULL, 'Socios', 'latin1', 'latin1_swedish_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '2'),
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3439'),
('INNODB_BUFFER_POOL_READS', '14'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '704'),
('INNODB_DATA_FSYNCS', '56'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '1983'),
('UPTIME_SINCE_FLUSH_STATUS', '1983');
...
(NULL, 'Socios', 'Asociados', 0, 'Socios', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'Socios', 'Mano', 0, 'Socios', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'Socios', 'Tareas', 0, 'Socios', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-01-10 15:11:58', '2012-01-10 15:11:58', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-01-10 15:11:59', '2012-01-10 15:11:59', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-01-10 15:11:59', '2012-01-10 15:11:59', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-01-10 15:11:59', '2012-01-10 15:11:59', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-01-10 15:11:59', '2012-01-10 15:11:59', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-01-10 15:11:59', '2012-01-10 15:11:59', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'Socios', 'Asociados', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 4194304, 2, '2012-01-10 15:04:49', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'Socios', 'Mano', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 4194304, 5, '2011-12-22 15:50:18', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'Socios', 'Tareas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 4194304, 3, '2012-01-10 15:04:49', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2011-12-22 15:00:18', '2011-12-22 15:00:18', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 440, 440, 123848989752688639, 5120, 0, NULL, '2011-12-22 15:00:19', '2011-12-22 15:03:49', '2011-12-22 15:00:19', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-22 15:00:19', '2011-12-22 15:00:19', NULL, 'utf8_general_ci', NULL, '', 'Events'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2011-12-22 15:00:18', '2011-12-22 15:00:18', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 452, 197, 89044, 55450570411999231, 16384, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 993, 9, 8937, 2533274790395903, 17408, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 857, 435464, 281474976710655, 20480, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2011-12-22 15:00:19', '2011-12-22 15:00:19', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-22 15:00:19', '2011-12-22 15:00:19', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2011-12-22 15:00:19', '2011-12-22 15:00:19', '2011-12-22 15:00:19', 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2011-12-22 15:00:18', '2011-12-22 15:00:18', '2011-12-22 15:00:18', 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2011-12-22 14:59:47', '2011-12-22 14:59:47', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 96, 484, 281474976710655, 2048, 0, NULL, '2011-12-22 15:00:19', '2011-12-22 15:03:49', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'phpmyadmin', 'pma_bookmark', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, 'utf8_bin', NULL, '', 'Bookmarks'),
(NULL, 'phpmyadmin', 'pma_column_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, 'utf8_bin', NULL, '', 'Column information for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_designer_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, 'utf8_bin', NULL, '', 'Table coordinates for Designer'),
(NULL, 'phpmyadmin', 'pma_history', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, 'utf8_bin', NULL, '', 'SQL history for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_pdf_pages', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, 'utf8_bin', NULL, '', 'PDF relation pages for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_relation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, NULL, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, 'utf8_bin', NULL, '', 'Relation table'),
(NULL, 'phpmyadmin', 'pma_table_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, 'utf8_bin', NULL, '', 'Table coordinates for phpMyAdmin PDF output'),
(NULL, 'phpmyadmin', 'pma_table_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, 'utf8_bin', NULL, '', 'Table information for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_tracking', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-22 15:03:50', '2011-12-22 15:03:50', NULL, 'utf8_bin', NULL, 'row_format=COMPACT', ''),
(NULL, 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 2048, 0, NULL, '2011-12-22 15:03:50', '2011-12-22 15:49:40', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin');
...
(NULL, 'Socios', 'PRIMARY', 'Socios', 'Asociados', 'PRIMARY KEY'),
(NULL, 'Socios', 'PRIMARY', 'Socios', 'Mano', 'PRIMARY KEY'),
(NULL, 'Socios', 'PRIMARY', 'Socios', 'Tareas', 'PRIMARY KEY'),
...
('''root''@''javier-VirtualBox''', NULL, 'SELECT', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'INSERT', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'UPDATE', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'DELETE', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'CREATE', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'DROP', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'RELOAD', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'SHUTDOWN', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'PROCESS', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'FILE', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'REFERENCES', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'INDEX', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'ALTER', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'SHOW DATABASES', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'SUPER', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'CREATE TEMPORARY TABLES', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'LOCK TABLES', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'EXECUTE', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'REPLICATION SLAVE', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'REPLICATION CLIENT', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'CREATE VIEW', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'SHOW VIEW', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'CREATE ROUTINE', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'ALTER ROUTINE', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'CREATE USER', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'EVENT', 'YES'),
('''root''@''javier-VirtualBox''', NULL, 'TRIGGER', 'YES'),
...
('localhost', 'root', '*E001C82432D33CD11D1478D69309B1733EB83282', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('javier-VirtualBox', 'root', '*E001C82432D33CD11D1478D69309B1733EB83282', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('127.0.0.1', 'root', '*E001C82432D33CD11D1478D69309B1733EB83282', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('localhost', 'debian-sys-maint', '*CABAACD32B4D9D02EE6BAAE77494FB46634C3271', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('localhost', 'phpmyadmin', '*E001C82432D33CD11D1478D69309B1733EB83282', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0);
--
...
('root', '2011-12-22 15:49:40', '{"lang":"es"}');
