...
class __TwigTemplate_818ac2885062f40bc9496913088a81c3 extends Twig_Template
{
...
<html>
    <head>
        ...
        // line 5
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/ocaso/css/demo.css"), "html", null, true);
    ...
    <body>
        ...
        echo "\">
                    <img src=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/ocaso/images/logo.gif"), "html", null, true);
        echo "\" alt=\"Symfony\">
                </a>
                <form id=\"symfony-search\" method=\"GET\" action=\"http://symfony.com/search\">
                    ...
                    <input type=\"submit\" class=\"symfony-button-grey\" value=\"Vale\" />
                </form>
            </div>
